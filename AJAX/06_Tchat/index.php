...
<body>
    ...
    <fieldset class="cadre_accueil">
        <form id="form">
            ...
            <input type="date" id="date_de_naissance" name="date_de_naissance" value="" placehorder="YYYY-MM-DD"><br>
    ...
    <script>
        // mise en place d'un événment sur la validation du formulaire
        document.getElementById("form").addEventListener("submit", function(e){
            e.preventDefault(); // on bloque la soumission du form. (pour éviter le rechargement de page)
