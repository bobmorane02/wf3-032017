...
if(isset($_GET['categorie']) && $_GET['categorie'] != 'all') {
    // si on à choisie une catégorie autre que "all" :
    ...
    // si on à demandé toutes les catégories :
    $donnees = executeRequete("SELECT id_produit,reference,titre,photo,prix,description FROM produit"); // pas de clause WHERE car on veux toutes les catégories
}
